;
; flashlpc.asm -- x86 FlashROM programmer
;
...
version     DB      13, 10, 'flashlpc version 0.3 (C) 2007, Merck Hung', 13, 10, 13, 10, 24h

usage       DB      'Usage: flashlpc IMAGE', 13, 10, 13, 10
